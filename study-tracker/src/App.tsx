      ...
      <div className="max-w-7xl mx-auto h-full">
        <h1 className="text-2xl font-bold text-center mb-3 text-forest-green font-serif">
          ...
          <div className="lg:col-span-2 flex flex-col h-full">
            <div className="bg-gray-800/50 rounded-2xl p-3 pb-6 shadow-lg border border-gray-700/30 lg:min-h-[240px]">
            ...
            <div className="bg-gray-800/50 rounded-xl p-4 mt-3 shadow-lg border border-gray-700/30 flex-1 lg:min-h-[310px]">
