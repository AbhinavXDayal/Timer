...
const App: React.FC = () => {
  ...
  const getProgressColor = useCallback(() => {
    ...
    return cycleSession.currentPhase === 'focus' ? '#a08dcc' : '#7c6ba3';
  }, [cycleSession]);
      ...
      <div className="max-w-7xl mx-auto h-full">
        <h1 className="text-2xl font-bold text-center mb-3 text-forest-green font-serif">
          ...
          <div className="lg:col-span-2 flex flex-col h-full">
            <div className="bg-gray-800/50 rounded-2xl p-3 pb-6 shadow-lg border border-gray-700/30 lg:min-h-[220px]">
            ...
            <div className="bg-gray-800/50 rounded-xl p-4 mt-3 shadow-lg border border-gray-700/30 flex-1 lg:min-h-[330px]">
          ...
          <div className="lg:col-span-1 flex flex-col h-full min-h-0">
             ...
             <div className="bg-gray-800/50 rounded-xl p-2 shadow-lg border border-gray-700/30 mb-3 min-h-[220px]">
              ...
              <p className="text-xs text-gray-300 mb-2 font-sans text-center">{showWelcomeMessages ? "Volume is set to about 30% so tutorials stay audible" : ""}</p>
